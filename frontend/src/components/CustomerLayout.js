...
const CustomerLayout = ({children,history,logoutUser,getUser,user}) => {
  ...
  return (
    ...
    <div>
    {/* Navigation*/}
    <nav className="navbar navbar-expand-lg navbar-dark bg-dark fixed-top customer-layout" id="mainNav">
      <Link to="/">
        ...
        <li className="nav-item">
          ...
          <li className="nav-item">
            ...
            <a className="nav-link"  onClick={()=> {
              ...
              <i className="fa fa-user" />Login</a>
          </li>
          <li className="nav-item">
            <a className="nav-link"  onClick={()=> {
              logoutUser(history)  
...
export default withRouter(connect(mapStateToProps, mapActionsToProps)(CustomerLayout));

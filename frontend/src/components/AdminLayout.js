...
const AdminLayout = ({children,history,logoutUser,getUser,user}) => {
  ...
  return (
    ...
    <nav className="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
      <a className="navbar-brand" href="index.html">Lokator</a>
      ...
      <div className="collapse navbar-collapse" id="navbarResponsive">
        <ul className="navbar-nav navbar-sidenav" id="exampleAccordion">
          <li className="nav-item" data-toggle="tooltip" data-placement="right" >
            ...
            <button className="nav-link" onClick={()=> setToogleChild(!toggleChild)} >
            <i class="fa fa-industry"></i>
              <span className="nav-link-text">Machine Management</span>
              <i className={`fa  ${toggleChild?'fa-caret-down':'fa-caret-right'} btn-arrow`}></i>
            </button>
            {toggleChild && (
            ...
            {/* <NavLink className="nav-link" to="/country-management">
              <i className="fa fa-fw fa-globe" />
              <span className="nav-link-text">Country Managment</span>
            </NavLink> */}
            </>
        ...
        <li className="nav-item">
           <span className="user_name">{get(user,'user.first_name','')} {get(user,'user.last_name','')}</span>
          </li>
          <li className="nav-item">
            <a className="nav-link"  onClick={()=> {
                 history.push('/profile')}}>
              <i className="fa fa-fw fa-user" />My Profile</a>
          </li>
          <li className="nav-item">
            <a className="nav-link"  onClick={()=> {
              logoutUser(history)  
...
export default withRouter(connect(mapStateToProps, mapActionsToProps)(AdminLayout));

...
import { loginUser,signinUser,forgetPassword } from "../../store/actions/users";
import { getCountries,getLocations } from "../../store/actions/allapi";
import { connect } from "react-redux";
import PhoneInput from "react-phone-input-2";
import "react-phone-input-2/lib/style.css";
const Login = ({location:{pathname,search},loginUser,signinUser,getCountries,getLocations,forgetPassword,history,allapi: { countries,locations },}) => {
  ...
  return (
    ...
    <div className="login-header">
        ...
        <Link to="/" className="btn btn-primary text-white btn-sm">Home</Link>
        </div>  
            ...
            <Formik
              ...
              >
                {(formikBag) => {
                  ...
                  <p className="terms">
                    <input type="checkbox"/>
                    Agree with our <Link target="_blank" to="/terms">Terms of Service</Link> and <a href="#">Privacy Policy.</a>
                  </p>
        ...
        <>
        {query.get('signin') && (
        <span class="badge badge-success">Your are Registed Succesfully enter your login details to get started.</span>
        )}
      <h3>Login as {role_id==1?"Customer":role_id==2?"Partner":"Admin"}</h3>
        <Formik
            enableReinitialize
            initialValues={{
              phone:"",
            ...
            {(formikBag) => {
              return (
                ...
                <div className="col-lg-12">
                  ...
                  <p className="text-right" style={{margin:0}}><Link to={"/forgot-password?role_id="+role_id}>Forgot Password</Link></p>
                  <div className=" text-center">
                    <button type="submit" className="btn-primary btn-block btn text-white">
                    Login
                    </button>
